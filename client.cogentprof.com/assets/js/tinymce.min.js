...
! function() {
            ...
            return ((e, t, n) => e.exists((e => ((e, t) => !xh(e) && kh(e, t).exists((e => {
                ...
                if (r.length > 0) {
                    if (o) return I.some(Ch.partialTable(r, I.none())); {
                        const e = Rh(n, t);
                        return I.some(Ch.partialTable(r, I.some({ ...t,
                            rng: e
                        })))
                    }
                }
    ...
    const Wy = (e, t, n, o) => {
        ...
        sC = (e, t) => {
            if (t.no_events) return sl.value(t); {
                const n = nC(t.content, (n => ((e, t) => e.dispatch("BeforeSetContent", t))(e, { ...t,
                    content: n
                })), oc(e));
    ...
    const xk = (e, t, n, o, r, s) => {
        ...
        UE = (e, t) => J(((e, t) => te((e => V(e, (e => ({ ...ME,
            ...e
        }))))(e), (e => IE(e, t) ? [e] : [])))(e, t), (e => e.action())),
        zE = (e, t) => ue(((e, t) => te((e => V(e, (e => ({ ...ME,
            ...e
        }))))(e), (e => IE(e, t) ? [e] : [])))(e, t), (e => e.action())),
        jE = (e, t) => {
            const n = t ? Jc.Forwards : Jc.Backwards,
    ...
    class QN {
        ...
        nodeChanged(e = {}) {
            ...
            if (this.editor.initialized && t && !wd(this.editor) && !this.editor.mode.isReadOnly()) {
                ...
                const r = [];
                this.editor.dom.getParent(n, (e => e === o || (r.push(e), !1))), this.editor.dispatch("NodeChange", { ...e,
                    element: n,
                    parents: r
                })
            }
    ...
    const dA = (e, t) => Math.abs(e.left - t),
        ...
        wO = Oa.DOM,
        xO = e => "-" === e.charAt(0),
        kO = (e, t, n) => I.from(t).filter((e => Ge(e) && !aw.has(e))).map((t => ({
        ...
        FO = Xt("font"),
        UO = e => (t, n) => I.from(n).map(yn).filter(Wt).bind((n => ((e, t, n) => hb(yn(n), (t => (t => uo(t, e).orThunk((() => FO(t) ? xe(IO, e).bind((e => tn(t, e))) : I.none())))(t)), (e => En(yn(t), e))))(e, t, n.dom).or(((e, t) => I.from(Oa.DOM.getStyle(t, e, !0)))(e, n.dom)))).getOr(""),
        zO = UO("font-size"),
        jO = S((e => e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")), UO("font-family")),
        HO = e => yu(e.getBody()).bind((e => {
            const t = e.container();
        ...
        })))(e).orThunk(O(HO, e)).map(yn).filter(Wt).bind(t))(e, _(I.some, t)),
        VO = (e, t) => {
            if (/^[0-9.]+$/.test(t)) {
        ...
        load(e = {}) {
            ...
            if (n) {
                const o = { ...e,
                    ...
                    s = t.setContent(r, o);
                return o.no_events || t.dispatch("LoadContent", { ...o,
                    element: n
                }), s
            }
            return ""
